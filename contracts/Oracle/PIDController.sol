...
contract PIDController is Ownable {
    ...
    function refreshCollateralRatio() public {
        ...
        uint256 fxs_liquidity = (fxs_reserves.mul(fxs_price));
        // Has 6 decimals of precision
        ...
        if (is_active) {
            ...
            if (new_collateral_ratio > last_collateral_ratio) {
                ...
                FRAX.setPriceTarget(0);
                // Set to zero to increase CR
                ...
                FRAX.setPriceTarget(1000e6);
                // Set to high value to decrease CR
            ...
            FRAX.setRefreshCooldown(0);
            // Unlock the CR cooldown
