...
contract PoolvAMM_USDC is FraxPoolvAMM {
    ...
    FraxPoolvAMM(_operatorMsg, _frax_contract_address, _fxs_contract_address, _collateral_address, _uniswap_factory_address, _fxs_usdc_oracle_addr, _pool_ceiling)
    {
