...
//        // [weth, factory, registry, poolRegistry, router] = await DeployThreePoolFactoryAndPancakeFactory(owner);
//
...
//
//
//        // pool = await DeployThreePoolByThreePoolFactory([token0, rusd, token1], {});
//
...
//
//           await AddLiquidityByPancakeRouter(pancakeFactory, [usdc, weth], pancakeRouter, toWei("1"), [toWei("0.1")], owner);
//         await AddLiquidityByPancakeRouter(pancakeFactory, [rusd, weth], router, toWei("1"), [toWei("0.1")], owner);
//         await AddLiquidityByPancakeRouter(pancakeFactory, [tra, weth], router, toWei("1"), [toWei("0.1")], owner);
//
//
